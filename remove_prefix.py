...
# Ask user to input the prefix to be removed
prefix = input("Input prefix to be removed: ")

# Print input without the prefix
if string.startswith(prefix):
    print("String after removing prefix:", string.strip(prefix))
else:
    print(string)